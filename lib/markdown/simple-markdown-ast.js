    ...
    function generate(depth, comment) {
        ...
        function paramList(params) {
            return u('list', {ordered: false}, params.map(function (param) {
                var description = param.description ? param.description.children : [];
                ...
                var typeNode = param.type ? u('strong', formatType(param.type)) : undefined;
                var inParagraph = [
                    u('inlineCode', param.name),
                    u('text', ' '),
                    typeNode,
                    u('text', ' ')
                ].concat(description, defaultParameters).filter(isNotUndefined);
        ...
        function returnsSection(comment) {
            return !!comment.returns && comment.returns.map(function (returns) {
                    var description = returns.description ? returns.description.children : [];
                    return u('paragraph', [
                        u('text', 'Returns '),
        ...
        function heading(comment) {
            ...
            return u('heading', {depth: depth}, [u('text', headName)])
        }
